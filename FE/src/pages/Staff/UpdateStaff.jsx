...
const UpdateStaff = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(
        "Failed to update staff. Please try again. Email or PhoneNumber might already existed! Check your password as well!"
      );
    } finally {
      setLoading(false);
    }
      ...
      >
        ...
        <div className="flex flex-col">
          ...
          <input
            ...
            value={staff.confirmPassword}
            onChange={(e) =>
              setStaff({ ...staff, confirmPassword: e.target.value })
            }
            required
            className="border p-2 rounded"
            placeholder="Confirm password"
